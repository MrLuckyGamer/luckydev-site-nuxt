  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'image', content: 'https://dev.luckydev.xyz/images/logo.png' },
        ...
        { property: 'og:url', content: 'https://dev.luckydev.xyz/' },
        { property: 'og:image', content: 'https://dev.luckydev.xyz/images/logo.png' },
        ...
        { name: 'twitter:image', content: 'https://dev.luckydev.xyz/images/logo.png' },
        { name: 'twitter:image:alt', content: 'Lucky Developments logo' },
      ],
      link: [
        { rel: 'canonical', href: 'https://dev.luckydev.xyz/' },
        { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
        { rel: 'shortcut icon', href: '/favicon.ico', type: 'image/x-icon' },
        { rel: 'apple-touch-icon', href: 'https://dev.luckydev.xyz/images/logo.png' },
