  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'image', content: 'https://luckydev.xyz/images/logo.png' },
        ...
        { property: 'og:image', content: 'https://luckydev.xyz/images/logo.png' },
        ...
        { name: 'twitter:image', content: 'https://luckydev.xyz/images/logo.png' },
      ...
      link: [
        ...
        { rel: 'apple-touch-icon', href: 'https://luckydev.xyz/images/logo.png' },
